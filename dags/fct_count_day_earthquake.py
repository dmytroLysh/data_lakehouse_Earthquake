...
with DAG(
    ...
    create_fct_table_if_not_exists = SQLExecuteQueryOperator(
        task_id="create_fct_table_if_not_exists",
        conn_id=PG_CONNECT,
        autocommit=True,
        sql=f"""
        CREATE SCHEMA IF NOT EXISTS {SCHEMA};
        CREATE TABLE IF NOT EXISTS {SCHEMA}.fct_count_day_earthquake (
        date DATE,
        count INTEGER
        )
        """,
    ...
    (
        ...
        >> create_stg_table
        >> create_fct_table_if_not_exists
